...
cwd = os.getcwd()
pictures = os.listdir(cwd+"\inputs")
sep = os.sep
for picture in pictures:
    input_image_path = cwd+sep+"inputs"+sep+picture
    resized_image_path = cwd+sep+"resized"+sep+picture
    coe_path = cwd+sep+"inputs"+sep+picture.replace("jpg","coe")
